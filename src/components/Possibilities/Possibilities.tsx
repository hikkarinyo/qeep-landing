            ...
            <div className={cx('possibilities__wrapper')}>
                ...
                <div className={cx('possibilities__col')}>
                    <Card className={cx('card')}>
                        ...
                        <p className={cx('card__description')}>уже через 2 дня ваши клиенты смогут скачать
                            приложение из App Store и Google Play</p>
                    </Card>
                    <Card className={cx('card')}>
                        <h1 className={cx('card__title')}>Сайт</h1>
                        <p className={cx('card__description')}>два инструмента на одной платформе</p>
                        <SvgIcon className={cx('card__image')} src={"/qeep-shop/notebook-catalog.svg"}></SvgIcon>
                    </Card>
                </div>
                <div className={cx('possibilities__col')}>
                    <Card className={cx('card', 'card_center')}>
                        <h1 className={cx('card__title')}>Кастомный дизайн</h1>
                        <SvgIcon className={cx('card__image')} src={"/grilled-shawarma/contacts.svg"} width={"282"}></SvgIcon>
                    </Card>
                    <Card className={cx('card', 'card_center')}>
