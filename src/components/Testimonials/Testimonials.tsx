...
const Testimonials = (props: TestimonialsProps) => {
    const testimonials = [
        ...
        {
            id: 2,
            logo: '/images/png/testimonials/pizza-ru/logo-pizza-ru.png',
            ...
            photo: '/images/png/testimonials/pizza-ru/author-pizza-ru.png',
            fullName: 'Петруненко Марк Игоревич',
            position: 'Управляющий делами Pizza.ru',
        },
        {
            id: 3,
            logo: '/images/png/testimonials/vt/logo-vt.svg',
            ...
            photo: '/images/png/testimonials/vt/author-vt.png',
